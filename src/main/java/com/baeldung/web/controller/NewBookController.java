...
public class NewBookController {
	...
	public MappingJacksonValue findByIsbn(@PathVariable final String isbn) {
		...
		final FilterProvider filterProvider = new SimpleFilterProvider().addFilter("bookFilter",
	...
	public List<NewBookResource> findAll() {
		...
		final List<NewBookResource> bookResources = books.stream()
			.map(NewBookResource::new)
